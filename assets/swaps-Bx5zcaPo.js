import{d3 as A,dN as l,d6 as w,d7 as D,d8 as C,dq as $,df as h,d9 as u,dw as V,dm as N,di as S,ds as M,dY as K,dn as F,dp as Q,d4 as W,d5 as q,eg as _}from"./index-ee26WOgh.js";import{S as s}from"./SwapController-DKqYOFNN.js";import"./index-qp0RhYsk.js";const H={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",U=a==="x",L=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||U)&&e.preventDefault(),t==="0"&&!L&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(L||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!L&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
...
`;var z=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let j=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};j.styles=[X];z([w()],j.prototype,"target",void 0);j=z([D("w3m-swap-input-skeleton")],j);const Z=A`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var E=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let P=class extends C{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var o;if(!this.visible)return null;const t=this.amount&&this.price?(o=h.multiply(this.price,this.amount))==null?void 0:o.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};P.styles=[W,q,oe];E([w()],P.prototype,"imageSrc",void 0);E([w()],P.prototype,"name",void 0);E([w()],P.prototype,"symbol",void 0);E([w()],P.prototype,"price",void 0);E([w()],P.prototype,"amount",void 0);E([l()],P.prototype,"visible",void 0);E([l()],P.prototype,"imageError",void 0);P=E([D("wui-token-list-item")],P);const ie=A`
  :host {
    width: 100%;
  }
